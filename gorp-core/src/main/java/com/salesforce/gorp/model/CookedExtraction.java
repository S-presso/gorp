...
public abstract class CookedExtraction
{
     ...
     */
    public ExtractionResult constructMatch(String input, String[] values, int length)
    {
        return new ExtractionResult(getName(), input, this, _extractorNames, values, length);
    }
